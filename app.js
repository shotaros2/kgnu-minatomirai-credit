  ...
  let html = `<div class="detail-view">
    ...
    <div class="detail-top-bar">
      ...
      <div class="detail-top-actions">
        ${!isShared ? '<button class="ws-import-btn-sm" onclick="showWsGuide()">📥 自動取込</button>' : ''}
...
function importFromPaste() {
  ...
  if (courses.length === 0) {
    alert('修得済み科目が見つかりませんでした。\nWebStationの「単位修得状況照会」ページで、表の見出し行（「科目大区分」「合否」などの行）から最後の行末まで選択してコピーしてください。');
    return;
  }
  closeWsGuide();
  if (currentDeptId) {
  ...
  overlay.innerHTML = `<div class="ws-modal">
    ...
    <div class="ws-steps">
      ...
      <div class="ws-step">
        ...
        <div class="ws-step-body">
          <div class="ws-step-title">表の<b>見出し行</b>から最後の行末までを選択してコピー</div>
          <div class="ws-step-desc">下の赤い範囲をドラッグで選択 → <b>Ctrl+C</b>（Mac: <b>Cmd+C</b>）<br>スマホ: 見出し行を長押し →「すべて選択」→「コピー」</div>
          <div class="ws-copy-example">
            ...
            <div class="ws-copy-table-wrap">
              <table class="ws-copy-table">
                ...
                <tr><td>41</td><td>専攻科目</td><td>展開科目（英語…）</td><td>Ｐｕｂｌｉｃ　Ｓ…</td><td>1.0</td><td>…</td><td>合</td></tr>
              </table>
            </div>
